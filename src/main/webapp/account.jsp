			...
			<div class="row justify-content-center">
				<div class="col-md-7 col-lg-5">
					<div class="wrap" style = " width:700px;margin-left:-100px;background-color:#4dd2ff60">
			      	...
			      	<div class="d-flex">
			      		<div class="w-100">
			      			<h3 class="mb-4"><%out.print(rs.getString(2));%> <%out.print(rs.getString(3));%></h3>
			      			<h2 class="mb-4"><%out.print(rs.getString(4));%></h2>
			      			<h2 class="mb-4"><%out.print(rs.getString(8));%></h2>
			      			<h2 class="mb-4"><%out.print(rs.getString(7));%></h2>
			      			<h2 class="mb-4"><%out.print(rs.getString(9));%></h2>
			      		</div>
								<div class="w-100">
		            ...
		            <div class="form-group">
		            	...
		            	<button class="btn btn-warning"><a href = "accountupdate.jsp">Update Account Details</a></button>
		            	<button class="btn btn-danger"><a href = "accountdelete.jsp">Delete Account</a></button>
