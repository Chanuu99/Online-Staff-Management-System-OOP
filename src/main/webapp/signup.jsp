...
<div class="container">
            <form class="form-horizontal" role="form">
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-9">
                        <input type="password" id="password" placeholder="Password" class="form-control" value="" required>
                    </div>
                </div>
                <div class="form-group">
               ...
               >
                    ...
                    <div class="col-sm-9">
            <textarea id="txtName" class="form-control"  name="text"  rows="4" cols="55" ></textarea><br>
         </div>
         </div>
                <div class="form-group">
