			      	...
			      	<div class="d-flex">
			      		<div class="w-100">
			      			...
			      			<div class="form-group">
			      				...
			      				<h5>First Name</h5>
								<input type = "text" class="form-control" name = "fName" value = "<%out.print(rs.getString(2));%>"><br>
								
								<h5>Last Name</h5>
								<input type = "text" class="form-control" name = "lname" value = "<%out.print(rs.getString(3));%>"><br>
								
								<h5>Email Name</h5>
								<input type = "text" class="form-control" name = "email" value = "<%out.print(rs.getString(4));%>"><br>
								
								<h5>City</h5>
								<input type = "text" class="form-control" name = "city" value = "<%out.print(rs.getString(6));%>"><br>
								
								<h5>Phone</h5>
								<input type = "text" class="form-control" name = "phone" value = "<%out.print(rs.getString(7));%>"><br>
								
								<h5>Status</h5>
								<input type = "text" class="form-control" name = "status" value = "<%out.print(rs.getString(9));%>"><br>
								
								<h5>Salary</h5>
								<input type = "text" class="form-control" name = "salary" value = "<%out.print(rs.getString(10));%>"><br>
								
								<h5>User Name</h5>
								<input type = "text" class="form-control" name = "uname" value = "<%out.print(rs.getString(11));%>"><br>
								
								<h5>Password</h5>
								<input type = "text" class="form-control" name = "pass" value = "<%out.print(rs.getString(12));%>"><br>
